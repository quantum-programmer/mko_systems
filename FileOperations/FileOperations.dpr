<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
    <PropertyGroup>
        <ProjectGuid>{D2C41869-9613-49E3-AD6B-165ACFB17741}</ProjectGuid>
        <ProjectVersion>20.2</ProjectVersion>
        <FrameworkType>None</FrameworkType>
        <Base>True</Base>
        <Config Condition="'$(Config)'==''">Debug</Config>
        <Platform Condition="'$(Platform)'==''">Win32</Platform>
        <ProjectName Condition="'$(ProjectName)'==''">FileOperations</ProjectName>
        <TargetedPlatforms>1</TargetedPlatforms>
        <AppType>Library</AppType>
        <MainSource>FileOperations.dpr</MainSource>
    </PropertyGroup>
    ...
    <PropertyGroup Condition="'$(Base)'!=''">
        ...
        <SanitizedProjectName>FileOperations</SanitizedProjectName>
    </PropertyGroup>
    ...
    <ItemGroup>
        ...
        <DCCReference Include="..\PluginAPI.pas"/>
        <DCCReference Include="FileOperationsTasks.pas"/>
    ...
    <ProjectExtensions>
        ...
        <BorlandProject>
            <Delphi.Personality>
                <Source>
                    <Source Name="MainSource">FileOperations.dpr</Source>
                </Source>
            </Delphi.Personality>
            <Deployment Version="5">
                ...
                <DeployFile LocalName="Win32\Debug\FileOperations.dll" Configuration="Debug" Class="ProjectOutput">
                    <Platform Name="Win32">
                        <RemoteName>FileOperations.dll</RemoteName>
                        <Overwrite>true</Overwrite>
                    </Platform>
                </DeployFile>
